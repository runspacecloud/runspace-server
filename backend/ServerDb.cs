// ═══════════════════════════════════════════════════════════════════════════
// ServerDb.cs  —  RunSpace server database schema + data helpers
// ═══════════════════════════════════════════════════════════════════════════
...
";
    ...
    public static List<object> GetMembers(string serverId)
    {
        ...
        foreach (var row in rows)
        {
            ...
            while (rr.Read())
                roles.Add(new { roleId = rr.GetString(0), name = rr.GetString(1),
                                color  = rr.GetString(2), position = rr.GetInt32(3),
    ...
    public static List<object> GetBans(string serverId)
    {
        ...
        using var r = c.ExecuteReader();
        while (r.Read())
            list.Add(new { userId    = r.GetString(0),
    ...
    public static List<object> GetInvites(string serverId)
    {
        ...
        using var r = c.ExecuteReader();
        while (r.Read())
            list.Add(new { code       = r.GetString(0),
